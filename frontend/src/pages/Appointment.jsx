                ...
                <div className='flex gap-3 items-center w-full overflow-x-scroll mt-4'>
                    {docSlots.length > 0 && docSlots.map((daySlot, index) => (
                        <div 
                            ...
                            key={index} 
                            className={`text-center py-6 min-w-20 rounded-full cursor-pointer ${slotIndex === index ? 'bg-primary text-white' : 'border border-[#DDDDDD]'}`}
                        >
                            <p>{daysOfWeek[daySlot.date.getDay()]}</p>
                            <p className='text-sm font-light'>{months[daySlot.date.getMonth()]}</p>
                            <p className='font-medium'>{daySlot.date.getDate()}</p>
                        </div>
                    ))}
                </div>
